package com.xml.authapp.dao;

import com.xml.authapp.util.AuthenticationUtilities;
import com.xml.authapp.util.AuthenticationUtilities.ConnectionProperties;
...
@Repository
public class AuthDaoLayer {

    private ConnectionProperties connectionProperties;
    private Collection collection;

    public AuthDaoLayer() throws Exception {
