...
public class XmlToPdfTransformer {
    ...
    public static final String INPUT_FILE = "src/main/resources/xml/P-1-generated.xml";

    public static final String XSL_FILE = "src/main/resources/xml/xslt.xsl";

    public static final String HTML_FILE = "src/main/resources/xml/bookstore.html";

    public static final String OUTPUT_FILE = "src/main/resources/xml/bookstore.pdf";
    ...
    public static void main(String[] args) throws IOException, DocumentException {
        ...
        System.out.println("[INFO] " + XmlToPdfTransformer.class.getSimpleName());
        ...
        XmlToPdfTransformer pdfTransformer = new XmlToPdfTransformer();
