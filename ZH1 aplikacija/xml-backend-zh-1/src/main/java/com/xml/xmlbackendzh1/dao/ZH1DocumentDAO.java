...
import com.xml.xmlbackendzh1.util.AuthenticationUtilities.ConnectionProperties;
import com.xml.xmlbackendzh1.util.AuthenticationUtilities;
...
@Repository
public class ZH1DocumentDAO {

    private ConnectionProperties connectionProperties;
    private String collectionId;
    private Collection collection;

    public ZH1DocumentDAO() throws Exception {
        this.connectionProperties = AuthenticationUtilities.loadProperties();
        this.collectionId = "/db/zig";
